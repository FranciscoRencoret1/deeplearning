...
model.fit_generator(gen_train, steps_per_epoch = len(list(gen_train)), epochs = 10, callbacks=callbacks_list, validation_data = gen_test, validation_steps = len(list(gen_test)))
